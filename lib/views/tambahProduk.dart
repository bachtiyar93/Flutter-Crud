      ...
      body: Form(
        ...
        child: ListView(
          ...
          children: <Widget>[
            ...
            TextFormField(
              onSaved: (e) => harga = e,
              decoration: InputDecoration(labelText: 'Harga Seluruhnya'),
            ),
            TextFormField(
              onSaved: (e) => harga = e,
              decoration: InputDecoration(labelText: 'Selesai pada'),
            ),
            MaterialButton(
              onPressed: () {
                check();
